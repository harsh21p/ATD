...
public final class FragmentValueSelectBinding implements ViewBinding {
  @NonNull
  private final ConstraintLayout rootView;

  @NonNull
  public final ImageView ivCloseValue;
  ...
  private FragmentValueSelectBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView ivCloseValue, @NonNull RecyclerView rvValue,
      @NonNull LinearLayoutCompat tireTypesHeader, @NonNull TextView tvBrands,
      @NonNull View viewSelectLocation) {
    this.rootView = rootView;
    this.ivCloseValue = ivCloseValue;
  ...
  @NonNull
  public static FragmentValueSelectBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentValueSelectBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_value_select, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentValueSelectBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.ivCloseValue;
      ImageView ivCloseValue = ViewBindings.findChildViewById(rootView, id);
      if (ivCloseValue == null) {
        break missingId;
      }

      id = R.id.rvValue;
      RecyclerView rvValue = ViewBindings.findChildViewById(rootView, id);
      if (rvValue == null) {
        break missingId;
      }
      ...
      return new FragmentValueSelectBinding((ConstraintLayout) rootView, ivCloseValue, rvValue,
