...
public final class FragmentSelectStateBinding implements ViewBinding {
  ...
  private FragmentSelectStateBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentSelectStateBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentSelectStateBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_select_state, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentSelectStateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSelectStateBinding((ConstraintLayout) rootView, ivCloseTireType, rvYears,
