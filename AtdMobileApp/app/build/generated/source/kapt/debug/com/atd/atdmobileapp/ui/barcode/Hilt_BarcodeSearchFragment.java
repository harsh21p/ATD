 ...
 */
public abstract class Hilt_BarcodeSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BarcodeSearchFragment() {
    super();
  }

  Hilt_BarcodeSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BarcodeSearchFragment_GeneratedInjector) this.generatedComponent()).injectBarcodeSearchFragment(UnsafeCasts.<BarcodeSearchFragment>unsafeCast(this));
    }
  }
