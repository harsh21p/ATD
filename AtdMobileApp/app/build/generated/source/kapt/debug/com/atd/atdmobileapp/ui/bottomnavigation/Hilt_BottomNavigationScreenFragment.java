 ...
 */
public abstract class Hilt_BottomNavigationScreenFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_BottomNavigationScreenFragment() {
    super();
  }

  Hilt_BottomNavigationScreenFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BottomNavigationScreenFragment_GeneratedInjector) this.generatedComponent()).injectBottomNavigationScreenFragment(UnsafeCasts.<BottomNavigationScreenFragment>unsafeCast(this));
    }
  }
