 ...
 */
public abstract class Hilt_ApprovalsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ApprovalsFragment() {
    super();
  }

  Hilt_ApprovalsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ApprovalsFragment_GeneratedInjector) this.generatedComponent()).injectApprovalsFragment(UnsafeCasts.<ApprovalsFragment>unsafeCast(this));
    }
  }
