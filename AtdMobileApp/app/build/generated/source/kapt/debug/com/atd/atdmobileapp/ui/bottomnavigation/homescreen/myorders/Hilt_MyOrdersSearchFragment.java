 ...
 */
public abstract class Hilt_MyOrdersSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyOrdersSearchFragment() {
    super();
  }

  Hilt_MyOrdersSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyOrdersSearchFragment_GeneratedInjector) this.generatedComponent()).injectMyOrdersSearchFragment(UnsafeCasts.<MyOrdersSearchFragment>unsafeCast(this));
    }
  }
