 ...
 */
public abstract class Hilt_MyOrderDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyOrderDetailsFragment() {
    super();
  }

  Hilt_MyOrderDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyOrderDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMyOrderDetailsFragment(UnsafeCasts.<MyOrderDetailsFragment>unsafeCast(this));
    }
  }
