 ...
 */
public abstract class Hilt_DeleteQuoteFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeleteQuoteFragment() {
    super();
  }

  Hilt_DeleteQuoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeleteQuoteFragment_GeneratedInjector) this.generatedComponent()).injectDeleteQuoteFragment(UnsafeCasts.<DeleteQuoteFragment>unsafeCast(this));
    }
  }
