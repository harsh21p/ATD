 ...
 */
public abstract class Hilt_MyGarageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyGarageFragment() {
    super();
  }

  Hilt_MyGarageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyGarageFragment_GeneratedInjector) this.generatedComponent()).injectMyGarageFragment(UnsafeCasts.<MyGarageFragment>unsafeCast(this));
    }
  }
