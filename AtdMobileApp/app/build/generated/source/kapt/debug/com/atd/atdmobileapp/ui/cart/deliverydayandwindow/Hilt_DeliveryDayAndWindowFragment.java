 ...
 */
public abstract class Hilt_DeliveryDayAndWindowFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeliveryDayAndWindowFragment() {
    super();
  }

  Hilt_DeliveryDayAndWindowFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeliveryDayAndWindowFragment_GeneratedInjector) this.generatedComponent()).injectDeliveryDayAndWindowFragment(UnsafeCasts.<DeliveryDayAndWindowFragment>unsafeCast(this));
    }
  }
