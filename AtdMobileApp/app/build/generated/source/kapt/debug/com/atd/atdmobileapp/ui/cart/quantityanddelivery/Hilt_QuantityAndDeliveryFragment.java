 ...
 */
public abstract class Hilt_QuantityAndDeliveryFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_QuantityAndDeliveryFragment() {
    super();
  }

  Hilt_QuantityAndDeliveryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((QuantityAndDeliveryFragment_GeneratedInjector) this.generatedComponent()).injectQuantityAndDeliveryFragment(UnsafeCasts.<QuantityAndDeliveryFragment>unsafeCast(this));
    }
  }
