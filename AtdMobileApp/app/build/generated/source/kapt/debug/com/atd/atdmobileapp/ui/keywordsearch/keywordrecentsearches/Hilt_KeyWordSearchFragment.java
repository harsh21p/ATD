 ...
 */
public abstract class Hilt_KeyWordSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_KeyWordSearchFragment() {
    super();
  }

  Hilt_KeyWordSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((KeyWordSearchFragment_GeneratedInjector) this.generatedComponent()).injectKeyWordSearchFragment(UnsafeCasts.<KeyWordSearchFragment>unsafeCast(this));
    }
  }
