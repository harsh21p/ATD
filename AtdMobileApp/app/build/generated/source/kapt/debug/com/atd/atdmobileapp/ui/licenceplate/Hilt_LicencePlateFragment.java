 ...
 */
public abstract class Hilt_LicencePlateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LicencePlateFragment() {
    super();
  }

  Hilt_LicencePlateFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LicencePlateFragment_GeneratedInjector) this.generatedComponent()).injectLicencePlateFragment(UnsafeCasts.<LicencePlateFragment>unsafeCast(this));
    }
  }
