 ...
 */
public abstract class Hilt_CreateMyListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateMyListFragment() {
    super();
  }

  Hilt_CreateMyListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateMyListFragment_GeneratedInjector) this.generatedComponent()).injectCreateMyListFragment(UnsafeCasts.<CreateMyListFragment>unsafeCast(this));
    }
  }
