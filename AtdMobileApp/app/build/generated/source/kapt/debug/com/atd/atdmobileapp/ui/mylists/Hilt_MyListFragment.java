 ...
 */
public abstract class Hilt_MyListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyListFragment_GeneratedInjector) this.generatedComponent()).injectMyListFragment(UnsafeCasts.<MyListFragment>unsafeCast(this));
    }
  }
