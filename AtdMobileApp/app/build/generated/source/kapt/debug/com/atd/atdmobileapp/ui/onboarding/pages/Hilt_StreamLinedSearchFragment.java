 ...
 */
public abstract class Hilt_StreamLinedSearchFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StreamLinedSearchFragment() {
    super();
  }

  Hilt_StreamLinedSearchFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StreamLinedSearchFragment_GeneratedInjector) this.generatedComponent()).injectStreamLinedSearchFragment(UnsafeCasts.<StreamLinedSearchFragment>unsafeCast(this));
    }
  }
