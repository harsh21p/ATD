 ...
 */
public abstract class Hilt_SuppliesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SuppliesFragment() {
    super();
  }

  Hilt_SuppliesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SuppliesFragment_GeneratedInjector) this.generatedComponent()).injectSuppliesFragment(UnsafeCasts.<SuppliesFragment>unsafeCast(this));
    }
  }
