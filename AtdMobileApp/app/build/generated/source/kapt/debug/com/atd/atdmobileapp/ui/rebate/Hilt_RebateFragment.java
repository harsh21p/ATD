 ...
 */
public abstract class Hilt_RebateFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RebateFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RebateFragment_GeneratedInjector) this.generatedComponent()).injectRebateFragment(UnsafeCasts.<RebateFragment>unsafeCast(this));
    }
  }
