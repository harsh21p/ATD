 ...
 */
public abstract class Hilt_SelectLocation extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SelectLocation(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectLocation_GeneratedInjector) this.generatedComponent()).injectSelectLocation(UnsafeCasts.<SelectLocation>unsafeCast(this));
    }
  }
