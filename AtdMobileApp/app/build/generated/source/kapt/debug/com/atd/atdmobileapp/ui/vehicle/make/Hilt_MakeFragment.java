 ...
 */
public abstract class Hilt_MakeFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MakeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MakeFragment_GeneratedInjector) this.generatedComponent()).injectMakeFragment(UnsafeCasts.<MakeFragment>unsafeCast(this));
    }
  }
