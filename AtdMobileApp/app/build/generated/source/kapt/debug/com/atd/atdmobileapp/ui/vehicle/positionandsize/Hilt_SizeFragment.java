 ...
 */
public abstract class Hilt_SizeFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SizeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SizeFragment_GeneratedInjector) this.generatedComponent()).injectSizeFragment(UnsafeCasts.<SizeFragment>unsafeCast(this));
    }
  }
