 ...
 */
public abstract class Hilt_TrimFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TrimFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TrimFragment_GeneratedInjector) this.generatedComponent()).injectTrimFragment(UnsafeCasts.<TrimFragment>unsafeCast(this));
    }
  }
