 ...
 */
public abstract class Hilt_YearFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_YearFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((YearFragment_GeneratedInjector) this.generatedComponent()).injectYearFragment(UnsafeCasts.<YearFragment>unsafeCast(this));
    }
  }
