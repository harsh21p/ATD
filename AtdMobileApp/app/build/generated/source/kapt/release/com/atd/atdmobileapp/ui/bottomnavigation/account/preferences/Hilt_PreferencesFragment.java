 ...
 */
public abstract class Hilt_PreferencesFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PreferencesFragment() {
    super();
  }

  Hilt_PreferencesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PreferencesFragment_GeneratedInjector) this.generatedComponent()).injectPreferencesFragment(UnsafeCasts.<PreferencesFragment>unsafeCast(this));
    }
  }
