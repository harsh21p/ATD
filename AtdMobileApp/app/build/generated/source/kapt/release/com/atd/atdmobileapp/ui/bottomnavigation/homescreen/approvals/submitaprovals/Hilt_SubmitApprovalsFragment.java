 ...
 */
public abstract class Hilt_SubmitApprovalsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SubmitApprovalsFragment() {
    super();
  }

  Hilt_SubmitApprovalsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SubmitApprovalsFragment_GeneratedInjector) this.generatedComponent()).injectSubmitApprovalsFragment(UnsafeCasts.<SubmitApprovalsFragment>unsafeCast(this));
    }
  }
