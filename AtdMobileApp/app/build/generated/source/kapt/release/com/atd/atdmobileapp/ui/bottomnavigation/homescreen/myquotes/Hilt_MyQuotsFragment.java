 ...
 */
public abstract class Hilt_MyQuotsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyQuotsFragment() {
    super();
  }

  Hilt_MyQuotsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyQuotsFragment_GeneratedInjector) this.generatedComponent()).injectMyQuotsFragment(UnsafeCasts.<MyQuotsFragment>unsafeCast(this));
    }
  }
