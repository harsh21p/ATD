 ...
 */
public abstract class Hilt_ViewMyQuotesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ViewMyQuotesFragment() {
    super();
  }

  Hilt_ViewMyQuotesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ViewMyQuotesFragment_GeneratedInjector) this.generatedComponent()).injectViewMyQuotesFragment(UnsafeCasts.<ViewMyQuotesFragment>unsafeCast(this));
    }
  }
