 ...
 */
public abstract class Hilt_HomeTabFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HomeTabFragment() {
    super();
  }

  Hilt_HomeTabFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HomeTabFragment_GeneratedInjector) this.generatedComponent()).injectHomeTabFragment(UnsafeCasts.<HomeTabFragment>unsafeCast(this));
    }
  }
