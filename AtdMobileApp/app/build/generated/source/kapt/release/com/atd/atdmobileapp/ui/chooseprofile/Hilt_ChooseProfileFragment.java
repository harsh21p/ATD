 ...
 */
public abstract class Hilt_ChooseProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChooseProfileFragment() {
    super();
  }

  Hilt_ChooseProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ChooseProfileFragment_GeneratedInjector) this.generatedComponent()).injectChooseProfileFragment(UnsafeCasts.<ChooseProfileFragment>unsafeCast(this));
    }
  }
