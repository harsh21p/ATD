 ...
 */
public abstract class Hilt_KeywordSearchResultsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_KeywordSearchResultsFragment() {
    super();
  }

  Hilt_KeywordSearchResultsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((KeywordSearchResultsFragment_GeneratedInjector) this.generatedComponent()).injectKeywordSearchResultsFragment(UnsafeCasts.<KeywordSearchResultsFragment>unsafeCast(this));
    }
  }
