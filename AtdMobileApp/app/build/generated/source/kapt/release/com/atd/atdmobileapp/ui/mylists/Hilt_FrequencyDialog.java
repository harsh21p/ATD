 ...
 */
public abstract class Hilt_FrequencyDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FrequencyDialog() {
    super();
  }

  Hilt_FrequencyDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FrequencyDialog_GeneratedInjector) this.generatedComponent()).injectFrequencyDialog(UnsafeCasts.<FrequencyDialog>unsafeCast(this));
    }
  }
