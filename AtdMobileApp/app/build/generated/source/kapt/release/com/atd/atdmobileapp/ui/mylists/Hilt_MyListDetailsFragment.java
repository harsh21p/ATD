 ...
 */
public abstract class Hilt_MyListDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyListDetailsFragment() {
    super();
  }

  Hilt_MyListDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyListDetailsFragment_GeneratedInjector) this.generatedComponent()).injectMyListDetailsFragment(UnsafeCasts.<MyListDetailsFragment>unsafeCast(this));
    }
  }
