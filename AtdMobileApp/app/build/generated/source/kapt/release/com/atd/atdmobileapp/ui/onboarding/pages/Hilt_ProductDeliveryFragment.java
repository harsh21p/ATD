 ...
 */
public abstract class Hilt_ProductDeliveryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductDeliveryFragment() {
    super();
  }

  Hilt_ProductDeliveryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductDeliveryFragment_GeneratedInjector) this.generatedComponent()).injectProductDeliveryFragment(UnsafeCasts.<ProductDeliveryFragment>unsafeCast(this));
    }
  }
