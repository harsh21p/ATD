 ...
 */
public abstract class Hilt_WelcomeToATDFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WelcomeToATDFragment() {
    super();
  }

  Hilt_WelcomeToATDFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WelcomeToATDFragment_GeneratedInjector) this.generatedComponent()).injectWelcomeToATDFragment(UnsafeCasts.<WelcomeToATDFragment>unsafeCast(this));
    }
  }
