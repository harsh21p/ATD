 ...
 */
public abstract class Hilt_ProductFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProductFragment() {
    super();
  }

  Hilt_ProductFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProductFragment_GeneratedInjector) this.generatedComponent()).injectProductFragment(UnsafeCasts.<ProductFragment>unsafeCast(this));
    }
  }
