 ...
 */
public abstract class Hilt_TubesAndFlapsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TubesAndFlapsFragment() {
    super();
  }

  Hilt_TubesAndFlapsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TubesAndFlapsFragment_GeneratedInjector) this.generatedComponent()).injectTubesAndFlapsFragment(UnsafeCasts.<TubesAndFlapsFragment>unsafeCast(this));
    }
  }
