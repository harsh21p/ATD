 ...
 */
public abstract class Hilt_TireRepairFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TireRepairFragment() {
    super();
  }

  Hilt_TireRepairFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TireRepairFragment_GeneratedInjector) this.generatedComponent()).injectTireRepairFragment(UnsafeCasts.<TireRepairFragment>unsafeCast(this));
    }
  }
