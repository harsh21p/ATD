 ...
 */
public abstract class Hilt_TiresFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TiresFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TiresFragment_GeneratedInjector) this.generatedComponent()).injectTiresFragment(UnsafeCasts.<TiresFragment>unsafeCast(this));
    }
  }
