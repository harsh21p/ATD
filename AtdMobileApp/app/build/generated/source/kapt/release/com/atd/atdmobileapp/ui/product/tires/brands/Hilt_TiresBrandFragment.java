 ...
 */
public abstract class Hilt_TiresBrandFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TiresBrandFragment() {
    super();
  }

  Hilt_TiresBrandFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TiresBrandFragment_GeneratedInjector) this.generatedComponent()).injectTiresBrandFragment(UnsafeCasts.<TiresBrandFragment>unsafeCast(this));
    }
  }
