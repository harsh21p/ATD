 ...
 */
public abstract class Hilt_WheelAccessoriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WheelAccessoriesFragment() {
    super();
  }

  Hilt_WheelAccessoriesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WheelAccessoriesFragment_GeneratedInjector) this.generatedComponent()).injectWheelAccessoriesFragment(UnsafeCasts.<WheelAccessoriesFragment>unsafeCast(this));
    }
  }
