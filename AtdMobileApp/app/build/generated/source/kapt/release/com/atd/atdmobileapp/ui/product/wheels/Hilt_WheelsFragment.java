 ...
 */
public abstract class Hilt_WheelsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WheelsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WheelsFragment_GeneratedInjector) this.generatedComponent()).injectWheelsFragment(UnsafeCasts.<WheelsFragment>unsafeCast(this));
    }
  }
