 ...
 */
public abstract class Hilt_VehicleSearch extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VehicleSearch(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VehicleSearch_GeneratedInjector) this.generatedComponent()).injectVehicleSearch(UnsafeCasts.<VehicleSearch>unsafeCast(this));
    }
  }
