 ...
 */
public abstract class Hilt_ModelFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ModelFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ModelFragment_GeneratedInjector) this.generatedComponent()).injectModelFragment(UnsafeCasts.<ModelFragment>unsafeCast(this));
    }
  }
