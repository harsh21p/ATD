 ...
 */
public abstract class Hilt_OESizeFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OESizeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OESizeFragment_GeneratedInjector) this.generatedComponent()).injectOESizeFragment(UnsafeCasts.<OESizeFragment>unsafeCast(this));
    }
  }
