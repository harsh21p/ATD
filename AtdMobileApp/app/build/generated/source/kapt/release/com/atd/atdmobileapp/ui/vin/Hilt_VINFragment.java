 ...
 */
public abstract class Hilt_VINFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VINFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VINFragment_GeneratedInjector) this.generatedComponent()).injectVINFragment(UnsafeCasts.<VINFragment>unsafeCast(this));
    }
  }
