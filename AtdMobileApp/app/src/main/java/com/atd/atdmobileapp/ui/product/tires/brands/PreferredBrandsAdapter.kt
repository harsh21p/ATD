...
class PreferredBrandsAdapter(
    private val onSelectPreferredBrandClicked: (Set<String>, Set<Int>) -> Unit,
    private val requireActivity: FragmentActivity
) :
    ListAdapter<String, PreferredBrandsAdapter.NestedViewHolder>(ComparatorDiffUtil()) {
    ...
    override fun onBindViewHolder(holder: NestedViewHolder, position: Int) {
        ...
        brand?.let {
            holder.bind(it, position,requireActivity)
        }
    }
    ...
    inner class NestedViewHolder(private val binding: NestedItemBinding) :
        ...
        fun bind(brand: String, position: Int, requireActivity: FragmentActivity) {
            ...
            binding.root.setOnClickListener {
                ...
                onSelectPreferredBrandClicked(selectedItems, getSelectedPositions())
