...
import com.atd.atdmobileapp.databinding.FragmentToolsBinding
...
class ToolsFragment : Fragment() {
    ...
    var _binding : FragmentToolsBinding?=null
    ...
    override fun onCreateView(
       ...
       var view:View= _binding!!.root
        ...
        binding.brandType.setOnClickListener {
            TiresBrandFragment(Constants.TOOLS).show(requireActivity().supportFragmentManager, TiresBrandFragment.TAG)
        }
        ...
        binding.tireRepairFooter.tvProductSearch.setOnClickListener {
            ...
            criteria.productgroup= listOf(Constants.TOOLS)
            ...
            val bundle = Bundle()
            bundle. putString(Constants.KEY_TYPE, Constants.TOOLS)
            bundle. putString(Constants.CATEGORY_TYPE, Category.Search_Criteria)
            bundle.putString(Constants.TOOLS, result)
