...
class SeasonalDesignationAdapter(
    private val list: ArrayList<String>,
    val updateViewModel: UpdateViewModel,
    val dialog: Dialog,
    val selectedList: ArrayList<String>,
    val requireActivity: FragmentActivity
) : RecyclerView.Adapter<SeasonalDesignationAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        selectedList.map {
            if (list.get(position).toString().equals( it,false)){
        ...
        holder.binding.rbWheelType.buttonTintList=
            ContextCompat.getColorStateList(requireActivity, BottomNavigationScreenFragment.theameColor)
        ...
        holder.binding.rbWheelType.setOnClickListener {
            ...
            updateViewModel.seasonalDesignation(list.get(position))
