...
class WheelsWidthAdapter(
...
) : RecyclerView.Adapter<WheelsWidthAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       // holder.binding.rbWheelType.setChecked(position == lastCheckedPosition);
        ...
        holder.binding.rbWheelType.buttonTintList=
            ContextCompat.getColorStateList(requireActivity1, BottomNavigationScreenFragment.theameColor)
    ...
    fun addAll() {
            ...
            updateViewModel.sendDiameterWidth(CheckedItemsList)
